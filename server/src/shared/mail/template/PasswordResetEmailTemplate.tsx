...
export const PasswordResetEmailTemplate = ({
  ...
  const TIME_EXPIRES = process.env.PASSWORD_RESET_EXPIRES_IN;
        ...
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={paragraph}>
              Hãy nhấn nút bên dưới để đặt lại mật khẩu của bạn.
            </Text>
            ...
            <Text style={note}>
              ...
              <strong>{formatDurationVN(TIME_EXPIRES as string)}</strong>.
            </Text>
            ...
            <Section style={fallbackBox}>
              ...
              <Text style={fallbackLink}>{passwordResetURL}</Text>
            </Section>
          </Section>
...
PasswordResetEmailTemplate.PreviewProps = {
  username: 'Cường',
  passwordResetURL: 'http://localhost:3000/reset-password?token=abc123',
